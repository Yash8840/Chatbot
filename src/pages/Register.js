      ...
      uploadTask.on(
        ...
        () => {
          ...
          getDownloadURL(uploadTask.snapshot.ref).then(async (downloadURL) => {
            ...
            await setDoc(doc(db, "chats", res.user.uid), { messages: [] }); // we store all the message of the current user in a an array called "messages" inside the collection called "chats" in firebase
            setIsLoading(false)
            navigate("/");
          });
        }
    ...
    <div className="theme">
      <div className="formContainer">
        <div className="formWrapper">
          <span className="logo">Wysa Chatbot</span>
